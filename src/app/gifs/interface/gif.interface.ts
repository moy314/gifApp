// To parse this data:
//
//   import { Convert, SearchGIFEngine } from "./file";
//
//   const searchGIFEngine = Convert.toSearchGIFEngine(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SearchGIFEngine {
    data:       Gif[];
...
export class Convert {
    public static toSearchGIFEngine(json: string): SearchGIFEngine {
        return cast(JSON.parse(json), r("SearchGIFEngine"));
    }

    public static searchGIFEngineToJson(value: SearchGIFEngine): string {
        return JSON.stringify(uncast(value, r("SearchGIFEngine")), null, 2);
    }
}
